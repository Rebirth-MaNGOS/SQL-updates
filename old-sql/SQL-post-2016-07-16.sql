...
REPLACE INTO `zp_mangosd`.`creature_template_addon` VALUES (16803, 0, 0, 1, 0, 36, 0, NULL);

-- add them to world again after being moved
REPLACE INTO `zp_mangosd`.`creature` VALUES (88461, 16803, 533, 16539, 0, 2762.43, -3085.16, 267.685, 2.18589, 21600, 0, 0, 600000, 0, 0, 0);
REPLACE INTO `zp_mangosd`.`creature` VALUES (88462, 16803, 533, 16539, 0, 2781.95, -3088.36, 267.685, 0.838932, 21600, 0, 0, 600000, 0, 0, 0);
REPLACE INTO `zp_mangosd`.`creature` VALUES (88463, 16803, 533, 16539, 0, 2778.31, -3113.39, 267.685, 5.35498, 21600, 0, 0, 600000, 0, 0, 0);
REPLACE INTO `zp_mangosd`.`creature` VALUES (88464, 16803, 533, 16539, 0, 2758.34, -3110.88, 267.685, 3.94518, 21600, 0, 0, 600000, 0, 0, 0);
